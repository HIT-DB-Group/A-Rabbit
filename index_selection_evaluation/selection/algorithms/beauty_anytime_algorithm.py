...
from ..beauty_selection_algorithm import BeautySelectionAlgorithm
...
class BeautyAnytimeAlgorithm(BeautySelectionAlgorithm):
    def __init__(self, database_connector, parameters=None):
        if parameters is None:
            parameters = {}
        BeautySelectionAlgorithm.__init__(
        ...
        self.name='beauty_anytime'

    def _calculate_best_indexes(self, workload,algname2time):
